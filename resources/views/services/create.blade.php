<x-app-layout>
    ...
    <x-slot name="header">
        <div class="flex flex-col gap-4 xl:flex-row xl:items-end xl:justify-between">
            <div>
                ...
                <p class="mt-2 text-sm sf-text-muted">Cadastre preço, duração, disponibilidade e imagem</p>
            </div>
    ...
    <div
        x-data="{
            ...
            isPubliclyAvailable: @js((bool) old('is_publicly_available', true)),
            availableForPos: @js((bool) old('available_for_pos', true)),
            imageName: '',
            uploadPreview: '',
                    ...
                    <div class="lg:col-span-2">
                        <div class="space-y-5 rounded-2xl border border-white/10 bg-[var(--input-bg)] px-4 py-4">
                            ...
                            <div class="rounded-2xl border border-dashed border-white/10 bg-[var(--app-shell-bg)]/70 px-4 py-4">
                                <label for="image" class="text-sm font-medium text-[var(--text-main)]">Ou envie a sua imagem</label>
                                <input
                                    id="image"
                                    x-ref="imageInput"
                                    name="image"
                                ...
                                >
                                <p class="mt-2 text-xs sf-text-muted">Use JPG, PNG ou WEBP para destacar o serviço no catalogo e no agendamento online.</p>
                            </div>
                    ...
                    <div class="mt-4 grid gap-4 md:grid-cols-2">
                        <div class="flex items-start gap-3 rounded-xl border border-white/10 bg-[var(--app-shell-bg)]/50 px-4 py-3">
                            ...
                            <input
                                ...
                                class="mt-1 h-4 w-4 rounded border-white/20 bg-[var(--app-shell-bg)] brand-text focus:ring-[var(--brand-primary)]"
                                @checked(old('is_publicly_available', true))
                            >
                            <div>
                        ...
                        <div class="flex items-start gap-3 rounded-xl border border-white/10 bg-[var(--app-shell-bg)]/50 px-4 py-3">
                            ...
                            <input
                                ...
                                class="mt-1 h-4 w-4 rounded border-white/20 bg-[var(--app-shell-bg)] brand-text focus:ring-[var(--brand-primary)]"
                                @checked(old('available_for_pos', true))
                            >
                            <div>
            ...
            <section class="sf-card overflow-hidden">
                ...
                <div class="space-y-4 px-5 py-5">
                    <div class="rounded-2xl border border-white/10 bg-[var(--input-bg)] px-4 py-4">
                        ...
                        <p class="mt-2 text-lg font-semibold text-[var(--text-main)]" x-text="name || 'Novo serviço completo'"></p>
                    </div>
                    ...
                    <div class="rounded-2xl border border-white/10 bg-[var(--input-bg)] px-4 py-4">
                        ...
                        <div class="mt-3 rounded-2xl border border-white/10 bg-[var(--app-shell-bg)]/60 px-3 py-3 text-xs sf-text-muted">
                            <template x-if="imageName">
                                <p><span class="font-semibold text-[var(--text-main)]" x-text="imageName"></span> pronta para envio.</p>
                            </template>
                    ...
                    <div class="rounded-2xl border border-white/10 bg-[var(--input-bg)] px-4 py-4">
                        ...
                        <p class="mt-2 text-sm" :class="active ? 'text-emerald-200' : 'sf-text-muted'" x-text="active ? 'Ativo e pronto para a agenda.' : 'Inativo até nova ativação.'"></p>
                    </div>
                </div>
            </section>
        </aside>
