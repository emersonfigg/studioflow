            ...
            <section class="sf-card overflow-hidden">
                ...
                <div class="space-y-4 px-5 py-5">
                    ...
                    <div class="rounded-2xl border border-white/10 bg-[#132746] px-4 py-4">
                        ...
                        <div class="mt-3 flex h-28 items-center justify-center rounded-2xl border border-dashed border-white/10 bg-[#1b335b]">
                            <template x-if="imageName">
                                <div class="px-4 text-center">
                                    <p class="text-sm font-semibold text-white" x-text="imageName"></p>
                                    <p class="mt-1 text-xs text-[#c7d2e3]">Imagem pronta para o catalogo visual.</p>
                                </div>
                            </template>
                            <template x-if="!imageName">
