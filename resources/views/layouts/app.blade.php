                    ...
                    <div class="sf-card sticky top-24 p-5">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-xs leading-5 text-[#c7d2e3]">{{ auth()->user()->isSuperAdmin() ? 'Agenda inteligente para barbearias, saloes e estetica' : (auth()->user()->company?->description ?: 'Agenda inteligente para barbearias, saloes e estetica') }}</p>
                            </div>
                        </div>
