                            ...
                            @php
                                if (auth()->user()->isSuperAdmin()) {
                                    ...
                                    $sidebarLinks = [
                                        ...
                                        ['label' => 'Financeiro', 'route' => 'finance.index', 'match' => 'finance.index|finance.production|finance.commissions*|finance.report|finance.performance|production.*', 'icon' => 'M3.5 5.75A2.25 2.25 0 015.75 3.5h8.5a2.25 2.25 0 012.25 2.25v8.5a2.25 2.25 0 01-2.25 2.25h-8.5A2.25 2.25 0 013.5 14.25v-8.5zm2.25-.75a.75.75 0 00-.75.75v8.5c0 .414.336.75.75.75h8.5a.75.75 0 00.75-.75v-8.5a.75.75 0 00-.75-.75h-8.5zm1.5 2.25a.75.75 0 000 1.5h5.5a.75.75 0 000-1.5h-5.5zm0 3a.75.75 0 000 1.5h5.5a.75.75 0 000-1.5h-5.5z'],
                                    ];
