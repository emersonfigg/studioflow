                            ...
                            @php
                                if (auth()->user()->isSuperAdmin()) {
                                    ...
                                    $sidebarLinks = [
                                        ...
                                        ['label' => 'Central do Dia', 'route' => 'daily-dashboard.index', 'match' => 'daily-dashboard.*', 'icon' => 'M4.75 3.5A1.75 1.75 0 003 5.25v9.5c0 .966.784 1.75 1.75 1.75h10.5A1.75 1.75 0 0017 14.75v-9.5a1.75 1.75 0 00-1.75-1.75H4.75zm0 1.5h10.5a.25.25 0 01.25.25V7h-11V5.25A.25.25 0 014.75 5zM4.5 8.5h11v6.25a.25.25 0 01-.25.25H4.75a.25.25 0 01-.25-.25V8.5zm2.25 1.5a.75.75 0 000 1.5h2.5a.75.75 0 000-1.5h-2.5zm0 2.5a.75.75 0 000 1.5h6.5a.75.75 0 000-1.5h-6.5z'],
                                        ...
                                        ['label' => 'Despesas', 'route' => 'expenses.index', 'match' => 'expenses.*', 'icon' => 'M4.5 4.75A1.75 1.75 0 016.25 3h7.5a1.75 1.75 0 011.75 1.75v10.5A1.75 1.75 0 0113.75 17h-7.5a1.75 1.75 0 01-1.75-1.75V4.75zm2 .75a.75.75 0 000 1.5h7a.75.75 0 000-1.5h-7zm0 3.25a.75.75 0 000 1.5h7a.75.75 0 000-1.5h-7zm0 3.25a.75.75 0 000 1.5h3.5a.75.75 0 000-1.5h-3.5z'],
                                        ...
                                        ['label' => 'Estoque', 'route' => 'stock.index', 'match' => 'stock.*', 'icon' => 'M4.5 5.25A2.25 2.25 0 016.75 3h6.5a2.25 2.25 0 012.25 2.25v8.5A2.25 2.25 0 0113.25 16h-6.5A2.25 2.25 0 014.5 13.75v-8.5zm2.25-.75a.75.75 0 00-.75.75v1.5h8v-1.5a.75.75 0 00-.75-.75h-6.5zM6 8.25v5.5c0 .414.336.75.75.75h6.5a.75.75 0 00.75-.75v-5.5H6zm2 1.5a.75.75 0 000 1.5h4a.75.75 0 000-1.5H8z'],
