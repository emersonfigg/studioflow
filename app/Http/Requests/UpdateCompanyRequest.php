...
class UpdateCompanyRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'booking_cover_images' => ['nullable', 'array', 'max:5'],
            'booking_cover_images.*' => ['image', 'mimes:jpg,jpeg,png,webp', 'max:4096'],
            'remove_booking_cover_media' => ['nullable', 'array'],
            'remove_booking_cover_media.*' => ['integer'],
