...
class UpdateCompanyPaymentIntegrationRequest extends FormRequest
{
    ...
    {
        return [
            'provider' => ['sometimes', Rule::enum(PaymentProvider::class)],
            ...
            'environment' => ['sometimes', Rule::enum(PaymentIntegrationEnvironment::class)],
